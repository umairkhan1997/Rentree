...
class ChatOpenEx extends React.Component {
  ...
  Accept = () => {
    fetch(
      `http://foodfella.net/Rentree/update_request.php?post_id=76&user_id=23`
    )
      .then(res => {
        if (res._bodyInit == '"success"') {
            ...
            >
              ...
              <View
                style={{
                  width: 100,
                  backgroundColor: "#0B3669",
                  marginTop: -10,justifyContent:'center',flexDirection:'row',marginRight:10
                }}
                >
              ...
              <View
                style={{
                  width: 100,
                  backgroundColor: "#0B3669",
                  marginTop: -10,justifyContent:'center',flexDirection:'row',marginLeft:10
                }}
              >
                <Text style={{ color: "white", }}>
                  REJECTED
